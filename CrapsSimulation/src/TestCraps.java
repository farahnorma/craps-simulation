...
public class TestCraps
{
	...
	public TestCraps()
	{
		...
		//game = new CrapsGame(new CrookedDie1(), new Die()); //one "crooked" Die object and one "fair"
		//game = new CrapsGame(new CrookedDie2(), new Die());
		//game = new CrapsGame(new CrookedDie1(), new CrookedDie1());
